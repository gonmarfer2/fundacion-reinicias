...
urlpatterns = [
    ...
    path('users/<int:user_id>/records/documents/add/',views.add_record_document,name='technics_add_record_documents'),
    path('users/<int:user_id>/records/documents/<int:document_id>/delete/',views.delete_record_document,name='technics_delete_record_documents'),
